<%@ page language="C#" autoeventwireup="true" CodeFile="Default7.aspx.cs" Inherits="Default7" MaintainScrollPositionOnPostback="true"%>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Button ID="Button2" runat="server" Text="Note -0,25" OnClick="Button2_Click"  /> &nbsp; &nbsp; &nbsp;
            <asp:Button ID="Button1" runat="server" Text="Note +0,25" OnClick="Button1_Click"  />
                    </td>
                    </tr>
            </table>
            <br/>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="ORDRE"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="NOTE" HeaderText="NOTE" ItemStyle-Font-Bold=true 
...
<ItemStyle Font-Bold="True"></ItemStyle>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                SelectCommand="SELECT ORDRE, NOTE, ECARTTYPE, CASE WHEN NOTE >= [OR] THEN 'OR' WHEN NOTE >= [ARGENT] AND NOTE < [OR] THEN 'ARGENT' WHEN NOTE >= [BRONZE] AND NOTE < [ARGENT] THEN 'BRONZE' ELSE '' END AS MEDAILLE, JURY, JURE1, JURE2, JURE3, JURE4, JURE5, JOUR, SERIE, RANG, [PRECALCUL].CATEGORIE, PAYS, APPELLATION, MILLESIME, FIRME, NOM, PRENOM, [CRU OU MARQUE], CAB, [NUMERO OXY], VOLUME, CEPAGE FROM [PRECALCUL], SEUIL_BY_CATEG SEUIL WHERE [PRECALCUL].CATEGORIE = SEUIL.CATEGORIE  AND ([PAYS] =@PAYS) ORDER BY [NOTE] DESC"
